...
exports.deleteSkill = exports.updateSkill = exports.addSkill = exports.getSkillCategories = exports.getSkills = void 0;
...
const getSkills = async (req, res) => {
    try {
        ...
        const formattedSkills = skills.map(skill => ({
            ...skill,
            categories: skill.skill_category_relations.map(rel => rel.skill_categories.category_name),
